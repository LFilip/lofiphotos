...
// This function adds the players it reset the number of players and
function addPlayers(){
deletePlayers();
...
// the onclick for the each player after creation
function addPoints(evt){
  let testString = ".score" + evt.target.index.toString();
  let playerScore = document.querySelector(testString);
