...
<head>
	<meta charset="utf-8">
	<title>LoFi Comp Sci</title>
	<meta name="description" content="LoFi Computer Science portfolio">
	<meta name="author" content="Louis Filip">
...
<div style="background-color:lightgrey;">
    <div class="row">
        <div class="col-md-6">
            ...
            <ol>
                ...
                <li><ul>
					<li>Limited Experience with the following:</li>
					<li>----------------------------</li>
					<li>Android Studio</li>
					<li>Lua and Corona SDK Android Development</li>
					<li>Hi Megan!</li>
				</ul></li>
            </ol>
	...
	<div class="aligned_calc">
		...
		<div>
			...
			<button class='display' onclick='erase()'>CLEAR</button>
			<button class='display' onclick='submit()'>SUBMIT</button>
			<button class='display'>/</button>
		</div>
	</div>
